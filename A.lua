--Cracked by Yame Yukana iz da best#9827
for _,v in pairs(game.workspace.Collectibles:GetChildren()) do
    ...
    --Properties:
    DarkCyberMainGUI.Name = "[Klem Hub]MainGUI"
    ...
    CreditText.Text = "Gui Create : klemplus"
    ...
    DiscordlinkTest.Text = "Link: https://discord.gg/bTADPAKqnA"
    ...
    Diamondmasktp.Text = "Diamond Mask (YOU NEED BUY THIS)"
    ...
    GummyMask.Text = "Gummy Mask (you need buy this)"
    ...
    DarkCyberLoadingGUI.Name = "[klem hub]LoadingGUI"
    ...
    DarkCyberSynapshitGUI.Name = "[klemplus]SynapshitGUI"
    ...
    Welcome.Text = "welcome to me Hub"
    ...
    setclipboard("https://discord.gg/bTADPAKqnA")
    end)
